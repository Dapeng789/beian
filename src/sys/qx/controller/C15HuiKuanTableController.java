		...
		if(workbook != null){
        		...
        		try {
        			...
        			for (int i = firstRowNum + 1; i <= lastRowNum; i++) {
        				...
        				Cell caoqianriqi  = row.getCell(12);
        				if(caoqianriqi == null) {
        				...
        				Cell zhengshiqianyueriqi  = row.getCell(13);
        				...
        				Cell  fangkanriqi  = row.getCell(15);
        				if(fangkanriqi == null) {
        				...
        				Cell  kehumingcheng  = row.getCell(16);
        				...
        				Cell  	dainajinjine = row.getCell(18);
        				...
        				Cell  	anjieleixing = row.getCell(19);
        				...
        				Cell  	fangkuanjine = row.getCell(20);
        				...
        				Cell   gongjijinjine = row.getCell(21);
        				...
        				System.out.println(c15ExcelTableBean.getLurudate());
