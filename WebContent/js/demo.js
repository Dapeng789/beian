...
layer.ready(function(){
  ...
  //公告
  if(local.notice_20180606 && new Date().getTime() - local.notice_20180606 < 1000*60*60*24*5){
    return;
  };
  ...
  layer.open({
    ...
    ,content: ['<div style="padding: 15px; text-align: center; background-color: #e2e2e2;">'
      ,'<a href="http://www.layui.com/admin/std/dist/views/" target="_blank"><img src="//cdn.layui.com/upload/2018_5/168_1527691799254_76462.jpg" alt="layuiAdmin" style="width: 100%; height:149.78px;"></a>'
    ,'</div>'].join('')
    ,success: function(layero, index){
      var btn = layero.find('.layui-layer-btn');
      btn.find('.layui-layer-btn0').attr({
        href: 'http://www.layui.com/admin/std/dist/views/'
        ,target: '_blank'
      });
