...
<!-- <input type ="text"  id="getValue" /> -->
	...
	<div id = "location1">
	  ...
	  <!-- action="initImportC03TableController/censorship.do" -->
	    <form  method="post"  id="f">
	    		<input class = "button bg-main icon-check-square-o" type="button" onClick="through();"  value = "审批通过" id= "sub">&nbsp &nbsp &nbsp &nbsp 
	    		
	    		<input class = "button bg-main icon-check-square-o" type="button" onClick="sendBack();"  value = "审批退回" id= "sub">
	    		<hr  width="200px" />
	    		...
	    		<input type = "text" readonly ="readonly" name = "zhongbiaojia" id = "zhongbiaojia" class = "location"/><br><br>
	    		...
	    		<div id = "beianData">
		    		...
		    		<input type = "text" readonly ="readonly" name = "lianxiren" id = "lianxiren" class = "location" list="sexlist">
		    		...
		    		<input type = "text" readonly ="readonly" name = "neiqin" id = "neiqin" class = "location"/><br><br>
		    		
		    		
		    		<!-- 供货单价 -->
		    		<label id= "style" >供货单价:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "gonghuodanjia" id = "gonghuodanjia" class = "location"/><br><br>
		    		
		    		
		    		<!-- 付款方式 -->
		    		<label id= "style" >付款方式:</label> <!-- 18 -->
		    	    <input type = "text"  readonly ="readonly"  name = "fukuanfangshi" id = "fukuanfangshi" class = "location"/><br><br>
		    		<!-- <select name="fukuanfangshi" readonly ="readonly"  id = "fukuanfangshi" class = "location"  >
		    		...
		    		<input type = "text" readonly ="readonly"  name = "buchazhouqi" id = "buchazhouqi" class = "location"/><br><br>
		    		<!-- <select name="buchazhouqi"  readonly ="readonly" id = "buchazhouqi" class = "location"  >
		    		...
		    		<input type = "text" readonly ="readonly" name = "buchadanjia" id = "buchadanjia" class = "location"/><br><br>
		    		...
		    		<input type = "text" readonly ="readonly" name = "baozhuangshuliang" id = "baozhuangshuliang" class = "location"/><br><br>
		    		
		    		
		    		<!-- 进货渠道 -->
		    		<label id= "style" >进货渠道:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "jinhuoqudao" id = "jinhuoqudao" class = "location"/><br><br>
		    		
		    		
		    		<!-- 医院 -->
		    		<label id= "style" >医院:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "yiyuan" id = "yiyuan" class = "location"/><br><br>
		    		<!-- <select name="yiyuan" readonly ="readonly" id = "yiyuan" class = "location"  >
						<option value="meiyou"></option>
		    		...
		    		<input type = "text" readonly ="readonly"  name = "dangqianzhuangtai" id = "dangqianzhuangtai" class = "location"/><br><br>
		    		<!-- <select name="dnagqianzhuangtai" readonly ="readonly" id = "dnagqianzhuangtai" class = "location"  >
		    			<option value="meiyou"></option>
		    		...
		    		<input type = "text" readonly ="readonly" name = "pinzhongtanpanren" id = "pinzhongtanpanren" class = "location"/><br><br>
		    		<!-- <select name="pinzhongtanpanren" readonly ="readonly" id = "pinzhongtanpanren" class = "location"  >
		    			<option value="meiyou"></option>
		    		...
		    		<input type = "text" readonly ="readonly" name = "honghuiID" id = "honghuiID" class = "location"/><br><br>
		    		
		    		
		    		<!-- 协议周期 -->
		    		<label id= "style" >协议周期:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "xieyizhouqi" id = "xieyizhouqi" class = "location"/><br><br>
		    		
		    		
		    		<!-- 年任务量 -->
		    		<label id= "style" >年任务量:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "nianrenwuliang" id = "nianrenwuliang" class = "location"/><br><br>
		    		
		    		
		    		<!-- 发票种类 -->
		    		<label id= "style" >发票种类:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "fapiaozhonglei" id = "fapiaozhonglei" class = "location"/><br><br>
		    		
		    		
		    		<!-- 是否补税点 -->
		    		<label id= "style" >是否补税点:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "shifoubushuidian" id = "shifoubushuidian" class = "location"/><br><br>
		    		...
		    		<!-- 备注 -->
		    		<div id = "styleOne1">
		    			<textarea  name = "beizhu" readonly ="readonly" id = "beizhu"   class = "location2" style="width: 710px; height: 100px;"></textarea>
		    		</div>
	    		...
	    		<div id ="beiandata1">
		    		...
		    		<input type = "text" readonly ="readonly" name = "lianxidianhua" id = "lianxidianhua" class = "location"/><br><br>
		    		
		    		<!-- 内勤电话 -->
		    		<label id= "style" >内勤电话:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "neiqindianhua" id = "neiqindianhua" class = "location"/><br><br>
		    		
		    		
		    		<!-- 供货扣率 -->
		    		<label id= "style" >供货扣率:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "gonghuokoulv" id = "gonghuokoulv" class = "location"/><br><br>
		    		
		    		<!-- 补差扣率 -->
		    		<label id= "style" >补差扣率:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "buchakoulv" id = "buchakoulv" class = "location"/><br><br>
		    		
		    		
		    		<!-- 厂家属性 -->
		    		<label id= "style" >厂家属性:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "changjiashuxing" id = "changjiashuxing" class = "location"/><br><br>
		    		<!-- <select name="changjiashuxing" readonly ="readonly" id = "changjiashuxing" class = "location"  >
		    		...
		    		<input type = "text" readonly ="readonly" name = "fahuolianxiren" id = "fahuolianxiren" class = "location"/><br><br>
		    		
		    		
		    		<!-- 医院ID -->
		    		<label id= "style" >医院ID:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "yiyuanID" id = "yiyuanID" class = "location"/><br><br>
		    		...
		    		<input type = "text" readonly ="readonly" name = "linchuangweihu" id = "linchuangweihu" class = "location"/><br><br> 
		    		<!-- <select name="linchuangweihu" readonly ="readonly" id = "linchuangweihu" class = "location"  >
						<option value="meiyou"></option>
		    		...
		    		<input type = "text" readonly ="readonly" name = "rukukuqu" id = "rukukuqu" class = "location"/><br><br>
		    		<!-- <select name="rukukuqu" readonly ="readonly" id = "rukukuqu" class = "location"  >
						<option value="meiyou"></option>
		    		...
		    		<input type = "text"  readonly ="readonly"  name = "shifoujinyuan" id = "shifoujinyuan" class = "location"/><br><br>
		    	<!-- 	<select name="shifoujinyuan" id = "shifoujinyuan" class = "location"  >
		    		...
		    		<input type = "text" readonly ="readonly" name = "baozhengjin" id = "baozhengjin" class = "location"/><br><br>
		    		
		    		
		    		<!-- 发票单位 -->
		    		<label id= "style" >发票单位:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "fapiaodanwei" id = "fapiaodanwei" class = "location"/><br><br>
		    		
		    		
		    		<!-- 利润实现方式 -->
		    		<label id= "style" >利润实现方式:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "lirunshixianfangshi" id = "lirunshixianfangshi" class = "location"/><br><br>
	    		...
	    		<!-- 利润实现方式 -->
		    		...
		    		<input type = "text" readonly ="readonly" name = "caigoufuzeren" id = "caigoufuzeren" class = "location"/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp	
		    		
		    		
		    		<!-- 利润实现方式 -->
		    		<label id= "style" >记录日期:</label> <!-- 18 -->
		    		<input type = "date" readonly ="readonly" name = "jiluruqi" id = "jiluruqi" class = "location"/>&nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp
		    		
		    		
		    		<!-- 利润实现方式 -->
		    		<label id= "style" >修改日期:</label> <!-- 18 -->
		    		<input type = "text" readonly ="readonly" name = "xiugairiqi" id = "xiugairiqi" class = "location"/><br><br>
 ...
 //获取session数据
        ...
        $("#lianxiren").val(sessionStorage.getItem('lianxiren')); 
        $("#neiqin").val(sessionStorage.getItem('neiqin')); 
        $("#gonghuodanjia").val(sessionStorage.getItem('gonghuodanjia')); 
        $("#fukuanfangshi").val(sessionStorage.getItem('fukuanfangshi')); 
        $("#buchazhouqi").val(sessionStorage.getItem('buchazhouqi')); 
        $("#buchadanjia").val(sessionStorage.getItem('buchadanjia')); 
        $("#baozhuangshuliang").val(sessionStorage.getItem('baozhuangshuliang')); 
        $("#jinhuoqudao").val(sessionStorage.getItem('jinhuoqudao')); 
        $("#yiyuan").val(sessionStorage.getItem('yiyuan')); 
        $("#dnagqianzhuangtai").val(sessionStorage.getItem('dnagqianzhuangtai')); 
        $("#pinzhongtanpanren").val(sessionStorage.getItem('pinzhongtanpanren')); 
        $("#honghuiID").val(sessionStorage.getItem('honghuiID')); 
        $("#xieyizhouqi").val(sessionStorage.getItem('xieyizhouqi')); 
        $("#nianrenwuliang").val(sessionStorage.getItem('nianrenwuliang')); 
        $("#fapiaozhonglei").val(sessionStorage.getItem('fapiaozhonglei')); 
        $("#shifoubushuidian").val(sessionStorage.getItem('shifoubushuidian')); 
        $("#beizhu").val(sessionStorage.getItem('beizhu')); 
        $("#lianxidianhua").val(sessionStorage.getItem('lianxidianhua')); 
        $("#neiqindianhua").val(sessionStorage.getItem('neiqindianhua')); 
        $("#gonghuokoulv").val(sessionStorage.getItem('gonghuokoulv')); 
        $("#buchakoulv").val(sessionStorage.getItem('buchakoulv')); 
        $("#changjiashuxing").val(sessionStorage.getItem('changjiashuxing')); 
        $("#fahuolianxiren").val(sessionStorage.getItem('fahuolianxiren')); 
        $("#yiyuanID").val(sessionStorage.getItem('yiyuanID')); 
        $("#linchuangweihu").val(sessionStorage.getItem('linchuangweihu')); 
        $("#rukukuqu").val(sessionStorage.getItem('rukukuqu')); 
        $("#shifoujinyuan").val(sessionStorage.getItem('shifoujinyuan')); 
        $("#baozhengjin").val(sessionStorage.getItem('baozhengjin')); 
        $("#fapiaodanwei").val(sessionStorage.getItem('fapiaodanwei')); 
        $("#lirunshixianfangshi").val(sessionStorage.getItem('lirunshixianfangshi')); 
        $("#caigoufuzeren").val(sessionStorage.getItem('caigoufuzeren')); 
        $("#jiluruqi").val(sessionStorage.getItem('jiluruqi')); 
        $("#xiugairiqi").val(sessionStorage.getItem('xiugairiqi')); 
        $("#caigoujingli").val(sessionStorage.getItem('caigoujingli')); 
        $("#zhuguanzongjingli").val(sessionStorage.getItem('zhuguanzongjingli')); 
        $("#caigoufuhe").val(sessionStorage.getItem('caigoufuhe')); 
        $("#code").val(sessionStorage.getItem('code')); 
        $("#purchasingManagerCode").val(sessionStorage.getItem('purchasingManagerCode')); 
        $("#operationManagerCode").val(sessionStorage.getItem('operationManagerCode')); 
        $("#reexamineCode").val(sessionStorage.getItem('reexamineCode')); 
        $("#purchasingManagerID").val(sessionStorage.getItem('purchasingManagerID')); 
        $("#operationManagerID").val(sessionStorage.getItem('operationManagerID')); 
        $("#reexamineID").val(sessionStorage.getItem('reexamineID')); 
 ...
 /* 通过 */
   function through(){
	//异步提交
		$.ajax({
			type:"POST",
			url:"${pageContext.request.contextPath }/initImportC03TableController/beInChargeYesOfDefeated.do",
			async : false,
			cache : false, 
   ...
   function sendBack(){
		//异步提交
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath }/initImportC03TableController/beInChargeNoOfDefeated.do",
				async : false,
				cache : false, 
				contentType : "application/x-www-form-urlencoded; charset=utf-8", //指定编码为UTF-8
				processData : false, 
