 ...
 /* 通过 */
   function through(){
	//异步提交
		$.ajax({
			type:"POST",
			url:"${pageContext.request.contextPath }/initImportC03TableController/purchasingThrough.do",
			async : false,
			cache : false, 
   ...
   function sendBack(){
		//异步提交
			$.ajax({
				type:"POST",
				url:"${pageContext.request.contextPath }/initImportC03TableController/purchasingDefeated.do",
				async : false,
				cache : false, 
				contentType : "application/x-www-form-urlencoded; charset=utf-8", //指定编码为UTF-8
				processData : false, 
